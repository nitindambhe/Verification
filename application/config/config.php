...
$config['base_url'] = $protocol . '://'.(isset( $_SERVER['HTTP_HOST'] ) ? $_SERVER['HTTP_HOST'] : '' ).'/Verification';
...
|
*/
$config['encryption_key'] = 'TalentMat';
...
$config['sess_cookie_name'] = 'talentmat';
...
|
*/
$config['cookie_prefix']    = '35.160.209.45';

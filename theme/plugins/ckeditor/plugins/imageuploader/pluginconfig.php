...
if(isset($_SESSION['username'])){
    ...
    if(isset($_POST["newpath"])){
        ...
        $data = '
    $useruploadfolder = "../theme/plugins/ckeditor/plugins/imageuploader/";
...
$useruploadpath = "../../../../../images/ckeditor_upladed_images/";
$foldershistory[] = $useruploadfolder;
$username = "sadmin"; $password = '4e48127094281838bdf762f2e79ca0af';

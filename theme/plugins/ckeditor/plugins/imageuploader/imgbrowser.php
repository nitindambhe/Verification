...
<p class="folderInfo"><?php //echo $imagebrowser2; ?>
...
<div id="uploadImgDiv" class="lightbox popout">
    ...
    <form action="imgupload.php" method="post" enctype="multipart/form-data" id="uploadImgForm" onsubmit="return checkUpload();">
        ...
        <br><h3 class="settingsh3" style="font-size:12px;font-weight:lighter;"><?php //   echo $uploadpanel2; ?><br><span style="font-weight:bolder;"></span></h3>
        <br>
    </form>
</div>
...
<div id="settingsDiv" class="lightbox popout">
    ...
    <?php if(isset($_SESSION["username"]) && $_SESSION["username"] != "disabled_pw"){ ?>

...
var Webcam = {
	...
	attach: function(elem) {
		...
		if (this.userMedia) {
			...
			.then( function(stream) {
                ...
                if (self.params.custom_function_call) {
                    self.params.custom_function_call();
                }
			})
			.catch( function(err) {
                if (self.params.custom_function_call) {
	...
	dispatch: function() {
		...
		if (this.hooks[name] && this.hooks[name].length) {
			...
			if (this.params.custom_function_call) {
				this.params.custom_function_call();
			}
		}
